...
class GameScene extends Phaser.Scene {
  ...
  createAnims() {
    this.start = this.physics.add.sprite(GAMECONSTANT.LEVEL_1_6_START.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_1_6_START.y + GAMECONSTANT.SPRITE_SIZE / 2, "start_anim");
    createStartAnims(this.anims);
    this.start.play(`start_idle`);

    this.end = this.physics.add.sprite(GAMECONSTANT.LEVEL_1_6_END.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_1_6_END.y + GAMECONSTANT.SPRITE_SIZE / 2, "end_anim");
  ...
  create() {
    ...
    const layerArray = [baseGroundLayer, gameBoard1Layer, gameBoard2Layer, propsLayer, props2Layer];
  ...
  endCheck() {
    (
      this.player.x >= GAMECONSTANT.LEVEL_1_6_END.x
      && this.player.y >= GAMECONSTANT.LEVEL_1_6_END.y
      && this.player.x < GAMECONSTANT.LEVEL_1_6_END.x + GAMECONSTANT.SPRITE_SIZE
      && this.player.y < GAMECONSTANT.LEVEL_1_6_END.y + GAMECONSTANT.SPRITE_SIZE
