...
class GameScene extends Phaser.Scene {
   ...
   */
  constructor(playerObject, bananaObject) {
    super("gameScene");
  ...
  createAnims() {
    this.start = this.physics.add.sprite(GAMECONSTANT.LEVEL_3_8_START.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_3_8_START.y + GAMECONSTANT.SPRITE_SIZE / 4, "start_anim");
    createStartAnims(this.anims);
    this.start.play(`start_idle`);

    this.end = this.physics.add.sprite(GAMECONSTANT.LEVEL_3_8_END.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_3_8_END.y + GAMECONSTANT.SPRITE_SIZE / 4, "end_anim");
  ...
  endCheck() {
    ...
    _.map([this.bananaObject], (item) => {
      isAllItemInPos = isAllItemInPos && item.getIsInPosition()
    });
    (
      this.player.x >= GAMECONSTANT.LEVEL_3_8_END.x &&
      this.player.y >= GAMECONSTANT.LEVEL_3_8_END.y &&
      this.player.x < GAMECONSTANT.LEVEL_3_8_END.x + GAMECONSTANT.SPRITE_SIZE &&
      this.player.y < GAMECONSTANT.LEVEL_3_8_END.y + GAMECONSTANT.SPRITE_SIZE && isAllItemInPos
  ...
  handleIsOnPosition() {
    if (
      ...
      (this.player.x === (384 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (512 + GAMECONSTANT.SPRITE_SIZE / 2))
    ) {
      ...
      (this.player.x === (576 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (448 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
