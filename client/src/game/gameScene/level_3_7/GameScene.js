...
class GameScene extends Phaser.Scene {
  ...
  createAnims() {
    this.start = this.physics.add.sprite(GAMECONSTANT.LEVEL_3_7_START.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_3_7_START.y + GAMECONSTANT.SPRITE_SIZE / 4, "start_anim");
    createStartAnims(this.anims);
    this.start.play(`start_idle`);

    this.end = this.physics.add.sprite(GAMECONSTANT.LEVEL_3_7_END.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_3_7_END.y + GAMECONSTANT.SPRITE_SIZE / 4, "end_anim");
  ...
  endCheck() {
    ...
    (
      this.player.x >= GAMECONSTANT.LEVEL_3_7_END.x &&
      this.player.y >= GAMECONSTANT.LEVEL_3_7_END.y &&
      this.player.x < GAMECONSTANT.LEVEL_3_7_END.x + GAMECONSTANT.SPRITE_SIZE &&
      this.player.y < GAMECONSTANT.LEVEL_3_7_END.y + GAMECONSTANT.SPRITE_SIZE && isAllItemInPos
  ...
  handleIsOnPosition() {
    if (
      ...
      (this.player.x === (192 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (256 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
      ...
      (this.player.x === (192 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (448 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
