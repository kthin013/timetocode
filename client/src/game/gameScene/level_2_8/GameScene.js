...
class GameScene extends Phaser.Scene {
  ...
  createAnims() {
    this.start = this.physics.add.sprite(GAMECONSTANT.LEVEL_2_8_START.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_2_8_START.y + GAMECONSTANT.SPRITE_SIZE / 4, "start_anim");
    createStartAnims(this.anims);
    this.start.play(`start_idle`);

    this.end = this.physics.add.sprite(GAMECONSTANT.LEVEL_2_8_END.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_2_8_END.y + GAMECONSTANT.SPRITE_SIZE / 4, "end_anim");
  ...
  create() {
    ...
    const layerArray = [baseGroundLayer, secondGroundLayer, gameBoard1Layer, gameBoard2Layer, propsLayer, props2Layer, itemUILayer];
  ...
  endCheck() {
    (
      this.player.x >= GAMECONSTANT.LEVEL_2_8_END.x &&
      this.player.y >= GAMECONSTANT.LEVEL_2_8_END.y &&
      this.player.x < GAMECONSTANT.LEVEL_2_8_END.x + GAMECONSTANT.SPRITE_SIZE &&
      this.player.y < GAMECONSTANT.LEVEL_2_8_END.y + GAMECONSTANT.SPRITE_SIZE
  ...
  handleIsOnPosition() {
    if ((this.player.x === (192 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (256 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
