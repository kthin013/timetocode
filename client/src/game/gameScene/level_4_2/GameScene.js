...
class GameScene extends Phaser.Scene {
  ...
  createAnims() {
    this.start = this.physics.add.sprite(GAMECONSTANT.LEVEL_4_2_START.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_4_2_START.y + GAMECONSTANT.SPRITE_SIZE / 4, "start_anim");
    createStartAnims(this.anims);
    this.start.play(`start_idle`);

    this.end = this.physics.add.sprite(GAMECONSTANT.LEVEL_4_2_END.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_4_2_END.y + GAMECONSTANT.SPRITE_SIZE / 4, "end_anim");
  ...
  endCheck() {
    ...
    (
      this.player.x >= GAMECONSTANT.LEVEL_4_2_END.x &&
      this.player.y >= GAMECONSTANT.LEVEL_4_2_END.y &&
      this.player.x < GAMECONSTANT.LEVEL_4_2_END.x + GAMECONSTANT.SPRITE_SIZE &&
      this.player.y < GAMECONSTANT.LEVEL_4_2_END.y + GAMECONSTANT.SPRITE_SIZE && isAllItemInPos
  ...
  handleIsOnPosition() {
    ...
    else if (this.player.x === (192 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (320 + GAMECONSTANT.SPRITE_SIZE / 2)) {
      this.playerObject.isOn = "red"
    }
    else if (
      (this.player.x === (320 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (192 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
      (this.player.x === (448 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (192 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
      (this.player.x === (512 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (256 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
      (this.player.x === (256 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (256 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
      (this.player.x === (256 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (384 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
