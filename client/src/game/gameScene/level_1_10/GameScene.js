...
class GameScene extends Phaser.Scene {
  ...
  createAnims() {
    this.start = this.physics.add.sprite(GAMECONSTANT.LEVEL_1_10_START.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_1_10_START.y + GAMECONSTANT.SPRITE_SIZE / 2, "start_anim");
    createStartAnims(this.anims);
    this.start.play(`start_idle`);

    this.end = this.physics.add.sprite(GAMECONSTANT.LEVEL_1_10_END.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_1_10_END.y + GAMECONSTANT.SPRITE_SIZE / 2, "end_anim");
  ...
  endCheck() {
    ...
    (
      this.player.x >= GAMECONSTANT.LEVEL_1_10_END.x &&
      this.player.y >= GAMECONSTANT.LEVEL_1_10_END.y &&
      this.player.x < GAMECONSTANT.LEVEL_1_10_END.x + GAMECONSTANT.SPRITE_SIZE &&
      this.player.y < GAMECONSTANT.LEVEL_1_10_END.y + GAMECONSTANT.SPRITE_SIZE && isAllItemInPos
