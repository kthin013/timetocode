...
class GameScene extends Phaser.Scene {
  ...
  createAnims() {
    this.start = this.physics.add.sprite(GAMECONSTANT.LEVEL_4_4_START.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_4_4_START.y + GAMECONSTANT.SPRITE_SIZE / 4, "start_anim");
    createStartAnims(this.anims);
    this.start.play(`start_idle`);

    this.end = this.physics.add.sprite(GAMECONSTANT.LEVEL_4_4_END.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_4_4_END.y + GAMECONSTANT.SPRITE_SIZE / 4, "end_anim");
  ...
  endCheck() {
    ...
    (
      this.player.x >= GAMECONSTANT.LEVEL_4_4_END.x &&
      this.player.y >= GAMECONSTANT.LEVEL_4_4_END.y &&
      this.player.x < GAMECONSTANT.LEVEL_4_4_END.x + GAMECONSTANT.SPRITE_SIZE &&
      this.player.y < GAMECONSTANT.LEVEL_4_4_END.y + GAMECONSTANT.SPRITE_SIZE && isAllItemInPos
  ...
  handleIsOnPosition() {
    if (
      ...
      (this.player.x === (256 + GAMECONSTANT.SPRITE_SIZE / 2) && this.player.y === (192 + GAMECONSTANT.SPRITE_SIZE / 2)) ||
