...
class GameScene extends Phaser.Scene {
  ...
  createAnims() {
    this.start = this.physics.add.sprite(GAMECONSTANT.LEVEL_2_6_START.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_2_6_START.y + GAMECONSTANT.SPRITE_SIZE / 4, "start_anim");
    createStartAnims(this.anims);
    this.start.play(`start_idle`);

    this.end = this.physics.add.sprite(GAMECONSTANT.LEVEL_2_6_END.x + GAMECONSTANT.SPRITE_SIZE / 2, GAMECONSTANT.LEVEL_2_6_END.y + GAMECONSTANT.SPRITE_SIZE / 4, "end_anim");
  ...
  endCheck() {
    ...
    (
      this.player.x >= GAMECONSTANT.LEVEL_2_6_END.x &&
      this.player.y >= GAMECONSTANT.LEVEL_2_6_END.y &&
      this.player.x < GAMECONSTANT.LEVEL_2_6_END.x + GAMECONSTANT.SPRITE_SIZE &&
      this.player.y < GAMECONSTANT.LEVEL_2_6_END.y + GAMECONSTANT.SPRITE_SIZE && isAllItemInPos
  ...
  handleItemsPosition() {
    ...
    // console.log(this.melonObject, this.playerObject);
  }

  handleIsOnPosition() {
    if (this.player.x === (384 + GAMECONSTANT.SPRITE_SIZE / 2)
      && this.player.y === (384 + GAMECONSTANT.SPRITE_SIZE / 2)) {
      this.playerObject.isOn = "green";
    } else if (this.player.x === (256 + GAMECONSTANT.SPRITE_SIZE / 2)
      && this.player.y === (320 + GAMECONSTANT.SPRITE_SIZE / 2)) {
