...
import Preloader from "../../game/gameScene/level_2_6/Preloader";
import GameScene from "../../game/gameScene/level_2_6/GameScene";
...
const Level_2_6 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_2_6_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_6_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_6_FACING, "2_6", gameState, setGameState
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_2_6,
      ...BlocklyConfig.WORKSPACE,
      maxInstances: { "controls_repeat_ext": 1, "num": 1, "movement": 5, "take": 1, "drop": 1, "turn": 1, "controls_if": 2, "isOn": 2 }
    });
