...
import Preloader from "../../game/gameScene/level_4_4/Preloader";
import GameScene from "../../game/gameScene/level_4_4/GameScene";
...
const Level_4_4 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_4_4_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_4_4_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_4_4_FACING, "4_4", gameState, setGameState
  ));
  const [orangeObject, setOrangeObject] = useState(new ItemSpriteObject(
    { x: 512 + GAMECONSTANT.SPRITE_SIZE / 2, y: 192 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 512 + GAMECONSTANT.SPRITE_SIZE / 2, y: 448 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 512 + GAMECONSTANT.SPRITE_SIZE / 2, y: 192 + GAMECONSTANT.SPRITE_SIZE / 2 },
    "orange"
  ));
  const [orangeObject2, setOrangeObject2] = useState(new ItemSpriteObject(
    { x: 256 + GAMECONSTANT.SPRITE_SIZE / 2, y: 448 + GAMECONSTANT.SPRITE_SIZE / 2 },
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_4_4,
