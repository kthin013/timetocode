...
import Preloader from "../../game/gameScene/level_3_5/Preloader";
import GameScene from "../../game/gameScene/level_3_5/GameScene";
...
const Level_3_5 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_3_5_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_3_5_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_3_5_FACING, "3_5", gameState, setGameState
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_3_5,
      ...BlocklyConfig.WORKSPACE,
      maxInstances: {
        "movement": 5, "take": 1, "drop": 1, "turn": 3, "controls_whileUntil": 1, "isHold": 4, "isOn": 4
      }
    });
