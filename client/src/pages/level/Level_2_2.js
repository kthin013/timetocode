...
import Preloader from "../../game/gameScene/level_2_2/Preloader";
import GameScene from "../../game/gameScene/level_2_2/GameScene";
...
const Level_2_2 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_2_2_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_2_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_2_FACING, "2_2", gameState, setGameState
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_2_2,
      ...BlocklyConfig.WORKSPACE,
      maxInstances: { "controls_repeat_ext": 1, "num": 1, "movement": 5, "turn": 1 }
    });
