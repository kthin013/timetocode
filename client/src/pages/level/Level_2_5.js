...
import Preloader from "../../game/gameScene/level_2_5/Preloader";
import GameScene from "../../game/gameScene/level_2_5/GameScene";
...
const Level_2_5 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_2_5_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_5_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_5_FACING, "2_5", gameState, setGameState
  ));
  const [melonObject, setMelonObject] = useState(new ItemSpriteObject(
    { x: 256 + GAMECONSTANT.SPRITE_SIZE / 2, y: 320 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 384 + GAMECONSTANT.SPRITE_SIZE / 2, y: 320 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 256 + GAMECONSTANT.SPRITE_SIZE / 2, y: 320 + GAMECONSTANT.SPRITE_SIZE / 2 },
    "melon"
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_2_5,
      ...BlocklyConfig.WORKSPACE,
      maxInstances: { "controls_repeat_ext": 1, "num": 1, "movement": 1, "take": 1, "drop": 1, "controls_if": 1, "isOn": 1 }
    });
