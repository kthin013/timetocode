...
import Preloader from "../../game/gameScene/level_1_1/Preloader";
import GameScene from "../../game/gameScene/level_1_1/GameScene";
...
const Level_1_1 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_1_1_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_1_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_1_FACING, "1_1", gameState, setGameState
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_1_1$2$5,
  ...
  return (
    <>
      ...
      {/* <CustomModal isModalVisible={isResultModalVisible} setIsModalVisible={setIsResultModalVisible} type={winOrLose} /> */}
      <TryModal
