...
import Preloader from "../../game/gameScene/level_1_7/Preloader";
import GameScene from "../../game/gameScene/level_1_7/GameScene";
...
const Level_1_7 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_1_7_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_7_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_7_FACING, "1_7", gameState, setGameState
  ));
