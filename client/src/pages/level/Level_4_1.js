...
import Preloader from "../../game/gameScene/level_4_1/Preloader";
import GameScene from "../../game/gameScene/level_4_1/GameScene";
...
const Level_4_1 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_4_1_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_4_1_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_4_1_FACING, "4_1", gameState, setGameState
  ));
  const [orangeObject, setOrangeObject] = useState(new ItemSpriteObject(
    { x: GAMECONSTANT.LEVEL_4_1_START.x + GAMECONSTANT.SPRITE_SIZE / 2, y: GAMECONSTANT.LEVEL_4_1_START.y + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 448 + GAMECONSTANT.SPRITE_SIZE / 2, y: 256 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: GAMECONSTANT.LEVEL_4_1_START.x + GAMECONSTANT.SPRITE_SIZE / 2, y: GAMECONSTANT.LEVEL_4_1_START.y + GAMECONSTANT.SPRITE_SIZE / 2 },
    "orange"
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_4_1,
