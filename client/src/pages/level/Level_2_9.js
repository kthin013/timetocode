...
import Preloader from "../../game/gameScene/level_2_9/Preloader";
import GameScene from "../../game/gameScene/level_2_9/GameScene";
...
const Level_2_9 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_2_9_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_9_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_9_FACING, "2_9", gameState, setGameState
  ));
  const [melonObject, setMelonObject] = useState(new ItemSpriteObject(
    { x: 320 + GAMECONSTANT.SPRITE_SIZE / 2, y: 256 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 320 + GAMECONSTANT.SPRITE_SIZE / 2, y: 384 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 320 + GAMECONSTANT.SPRITE_SIZE / 2, y: 256 + GAMECONSTANT.SPRITE_SIZE / 2 },
    "melon"
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_2_9,
      ...BlocklyConfig.WORKSPACE,
      maxInstances: { "controls_repeat_ext": 1, "num": 1, "movement": 3, "take": 1, "drop": 1, "turn": 1, "controls_if": 2, "isOn": 2 }
    });
