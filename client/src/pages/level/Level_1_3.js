...
import Preloader from "../../game/gameScene/level_1_3/Preloader";
import GameScene from "../../game/gameScene/level_1_3/GameScene";
...
const Level_1_3 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_1_3_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_3_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_3_FACING, "1_3", gameState, setGameState
  ));
