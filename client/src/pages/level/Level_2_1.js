...
import Preloader from "../../game/gameScene/level_2_1/Preloader";
import GameScene from "../../game/gameScene/level_2_1/GameScene";
...
const Level_2_1 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_2_1_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_1_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_1_FACING, "2_1", gameState, setGameState
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_2_1,
      ...BlocklyConfig.WORKSPACE,
      maxInstances: { "controls_repeat_ext": 1, "num": 1, "movement": 1 }
    });
