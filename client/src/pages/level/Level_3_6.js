...
import Preloader from "../../game/gameScene/level_3_6/Preloader";
import GameScene from "../../game/gameScene/level_3_6/GameScene";
...
const Level_3_6 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_3_6_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_3_6_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_3_6_FACING, "3_6", gameState, setGameState
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_3_6,
      ...BlocklyConfig.WORKSPACE,
      maxInstances: {
        "movement": 2, "take": 1, "drop": 1, "turn": 3, "controls_whileUntil": 1,
      }
    });
