...
import Preloader from "../../game/gameScene/level_1_5/Preloader";
import GameScene from "../../game/gameScene/level_1_5/GameScene";
...
const Level_1_5 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_1_5_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_5_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_5_FACING, "1_5", gameState, setGameState
  ));
