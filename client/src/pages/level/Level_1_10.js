...
import Preloader from "../../game/gameScene/level_1_10/Preloader";
import GameScene from "../../game/gameScene/level_1_10/GameScene";
...
const Level_1_10 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_1_10_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_10_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_10_FACING, "1_10", gameState, setGameState
  ));
  const [appleObject, setAppleObject] = useState(new ItemSpriteObject(
    { x: 128 + GAMECONSTANT.SPRITE_SIZE / 2, y: 320 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 192 + GAMECONSTANT.SPRITE_SIZE / 2, y: 448 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 128 + GAMECONSTANT.SPRITE_SIZE / 2, y: 320 + GAMECONSTANT.SPRITE_SIZE / 2 },
    "apple"
  ));
