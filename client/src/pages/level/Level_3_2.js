...
import Preloader from "../../game/gameScene/level_3_2/Preloader";
import GameScene from "../../game/gameScene/level_3_2/GameScene";
...
const Level_3_2 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_3_2_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_3_2_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_3_2_FACING, "3_2", gameState, setGameState
  ));
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_3_2,
      ...BlocklyConfig.WORKSPACE,
      maxInstances: {
        "movement": 2, "controls_whileUntil": 1,
      }
    });
