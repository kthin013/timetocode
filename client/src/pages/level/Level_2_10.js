...
import Preloader from "../../game/gameScene/level_2_10/Preloader";
import GameScene from "../../game/gameScene/level_2_10/GameScene";
...
const Level_2_10 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_2_10_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_10_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_2_10_FACING, "2_10", gameState, setGameState
  ));
  const [melonObject, setMelonObject] = useState(new ItemSpriteObject(
    { x: 192 + GAMECONSTANT.SPRITE_SIZE / 2, y: 256 + GAMECONSTANT.SPRITE_SIZE / 2 },
  ...
  useEffect(() => {
    ...
    blocklyWorkspaceRef.current = Blockly.inject("blocklyDiv", {
      toolbox: BlocklyConfig.TOOLBOX_LEVEL_2_10,
      ...BlocklyConfig.WORKSPACE,
      maxInstances: { "controls_repeat_ext": 1, "num": 1, "movement": 2, "take": 1, "drop": 1, "turn": 2, "controls_if": 2, "isOn": 2 }
    });
