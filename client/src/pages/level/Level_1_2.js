...
import Preloader from "../../game/gameScene/level_1_2/Preloader";
import GameScene from "../../game/gameScene/level_1_2/GameScene";
...
const Level_1_2 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_1_2_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_2_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_2_FACING, "1_2", gameState, setGameState
  ));
