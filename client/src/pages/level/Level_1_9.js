...
import Preloader from "../../game/gameScene/level_1_9/Preloader";
import GameScene from "../../game/gameScene/level_1_9/GameScene";
...
const Level_1_9 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_1_9_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_9_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_9_FACING, "1_9", gameState, setGameState
  ));
  const [appleObject, setAppleObject] = useState(new ItemSpriteObject(
    { x: 192 + GAMECONSTANT.SPRITE_SIZE / 2, y: 384 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 320 + GAMECONSTANT.SPRITE_SIZE / 2, y: 320 + GAMECONSTANT.SPRITE_SIZE / 2 },
    { x: 192 + GAMECONSTANT.SPRITE_SIZE / 2, y: 384 + GAMECONSTANT.SPRITE_SIZE / 2 },
    "apple"
  ));
