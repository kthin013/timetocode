...
import Preloader from "../../game/gameScene/level_1_6/Preloader";
import GameScene from "../../game/gameScene/level_1_6/GameScene";
...
const Level_1_6 = () => {
  ...
  const [playerObject, setPlayerObject] = useState(new SpriteObject(
    GAMECONSTANT.LEVEL_1_6_START.x + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_6_START.y + GAMECONSTANT.SPRITE_SIZE / 2,
    GAMECONSTANT.LEVEL_1_6_FACING, "1_6", gameState, setGameState
  ));
